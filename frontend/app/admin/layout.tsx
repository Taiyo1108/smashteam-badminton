...
import { 
  ...
  Image as ImageIcon, Calendar, Sparkles, ShoppingBag, Home 
} from "lucide-react";
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Sidebar */}
      <aside className={`fixed lg:static inset-y-0 left-0 w-64 bg-secondary text-slate-300 z-50 transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0 transition-transform duration-300 flex flex-col border-r border-purple-950/40 shadow-xl`}>
